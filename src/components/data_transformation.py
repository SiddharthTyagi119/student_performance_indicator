    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            num_pipeline= Pipeline(
                steps=[
                #handling missing values and doing scaling
            ...
            cat_pipeline=Pipeline(
                ...
                steps=[
                #handling missing values , converting to data to numerical and scaling 
     ...
     #starting data transformation under this function   
